...
<a href="../../slides/04_Alignment/02_Approximate_matching_Langmead.pdf" target="_blank">"Approximate matching" Lecture slides in PDF format</a>


<a href="../../slides/04_Alignment/03_Needleman_Wunsch_xaringan.html#1" target="_blank">Lecture slides in HTML format</a>

```{r echo=FALSE}
knitr::include_url('../../slides/04_Alignment/03_Needleman_Wunsch_xaringan.html#1')
```

<a href="../../slides/04_Alignment/04_Smith-Waterman.pdf" target="_blank">"Smith-Waterman" Lecture slides in PDF format</a>

<a href="../../slides/04_Alignment/05_BWT_xaringan.html#1" target="_blank">Lecture slides in HTML format</a>

```{r echo=FALSE}
knitr::include_url('../../slides/04_Alignment/05_BWT_xaringan.html#1')
```

<a href="../../slides/04_Alignment/05_BWT.pdf" target="_blank">"Burrows–Wheeler Transform" Lecture slides in PDF format</a>

# Code

- Naive exact matching, [naive_exact.R](../../slides/04_Alignment/lab/naive_exact.R)
- Naive approximate matching, [naive_Hamming.R](../../slides/04_Alignment/lab/naive_Hamming.R)  
- Edit distance, recursive implementation, [edDistRecursive.R](../../slides/04_Alignment/lab/edDistRecursive.R)
- Edit distance, dynamic programming implementation, [edDistDynamic.R](../../slides/04_Alignment/lab/edDistDynamic.R)
- Global alignment, dynamic programming implementation, [globalAlignment.R](../../slides/04_Alignment/lab/globalAlignment.R)
...
- Needleman, S. B., and C. D. Wunsch. “A General Method Applicable to the Search for Similarities in the Amino Acid Sequence of Two Proteins.” Journal of Molecular Biology 48, no. 3 (March 1970): 443–53.
    - Online demo: https://bioboot.github.io/bimm143_W20/class-material/nw/
