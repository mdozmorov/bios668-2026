...
.pull-left[
```{r echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE, fig.height=4, fig.width=6, fig.align='left'}
# Plot t-SNE result
...
.pull-left[
```{r echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE, fig.height=5, fig.width=8, fig.align='center'}
...
.pull-right[
```{r echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE, fig.align='center', fig.height=4}
# Plot
...
<!-- - Revolutionized flow cytometry and mass cytometry analysis -->

<!-- **Modern Single-Cell RNA-seq:** -->
<!-- - t-SNE became standard for visualizing cell types -->
<!-- - Helps identify novel cell populations -->
<!-- - Reveals developmental trajectories -->
<!-- - Now often complemented by UMAP -->
...
<!-- Chari, T., et al. (2023). The specious art of single-cell genomics. *PLOS Comput. Biol.*, *19*(8), e1011288. -->
