...
- Modern aligners (Bowtie, bwa) employ Burrows-Wheeler transform (BWT) based on the full-text minute-space (FM) index.
...
- BWT has a memory footprint of 1.3 GB for the human genome. Very fast.

- The Last-First (LF) mapping can transform it back to the original sequence.
